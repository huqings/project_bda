...
var maybeReactUseId = React5["useId"];
...
true ? ClickAwayListener.propTypes = {
  ...
  mouseEvent: import_prop_types12.default.oneOf(["onClick", "onMouseDown", "onMouseUp", false]),
...
function Unstable_TrapFocus(props) {
  ...
  const ignoreNextEnforceFocus = React22.useRef();
...
var ModalUnstyled = React23.forwardRef(function ModalUnstyled2(props, ref) {
  const {
    BackdropComponent,
    BackdropProps,
    children,
  ...
  return (0, import_jsx_runtime12.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime13.jsxs)(Root, _extends({
      role: "presentation"
      ...
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime12.jsx)(BackdropComponent, _extends({
        open,
        onClick: handleBackdropClick
      }, BackdropProps)) : null, (0, import_jsx_runtime12.jsx)(Unstable_TrapFocus_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var TextareaAutosize = React25.forwardRef(function TextareaAutosize2(props, ref) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
var _excluded10 = ["classes", "className", "invisible", "component", "components", "componentsProps", "theme"];
...
var BackdropUnstyled = React26.forwardRef(function BackdropUnstyled2(props, ref) {
  const {
    classes: classesProp,
    className,
    invisible = false,
  ...
  const Root = components.Root || component;
  const rootProps = componentsProps.root || {};
  return (0, import_jsx_runtime17.jsx)(Root, _extends({
    "aria-hidden": true
  }, rootProps, !isHostComponent_default(Root) && {
    as: component,
    ownerState: _extends({}, ownerState, rootProps.ownerState),
...
var _excluded11 = ["anchorOrigin", "classes", "badgeContent", "component", "children", "className", "components", "componentsProps", "invisible", "max", "showZero", "variant"];
...
true ? BadgeUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types19.default.shape({
    badge: import_prop_types19.default.object,
...
var _excluded12 = ["className", "component", "components", "componentsProps", "children", "disabled", "action", "onBlur", "onClick", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseLeave"];
...
var ButtonUnstyled = React29.forwardRef(function ButtonUnstyled2(props, ref) {
  var _ref;
  const {
    className,
    component,
  ...
  return (0, import_jsx_runtime20.jsx)(ButtonRoot, _extends({}, getRootProps(), buttonRootProps, {
...
var FormControlUnstyledContext = React30.createContext(void 0);
if (true) {
...
var _excluded13 = ["defaultValue", "children", "className", "component", "components", "componentsProps", "disabled", "error", "focused", "onChange", "required", "value"];
function hasValue(value) {
  return value != null && !(Array.isArray(value) && value.length === 0) && value !== "";
}
var FormControlUnstyled = React31.forwardRef(function FormControlUnstyled2(props, ref) {
  var _ref;
  const {
    defaultValue,
    children,
...
var _excluded14 = ["aria-describedby", "aria-label", "aria-labelledby", "autoComplete", "autoFocus", "className", "component", "components", "componentsProps", "defaultValue", "disabled", "endAdornment", "error", "id", "maxRows", "minRows", "multiline", "name", "onClick", "onChange", "onKeyDown", "onKeyUp", "onFocus", "onBlur", "placeholder", "readOnly", "required", "rows", "type", "startAdornment", "value"];
var InputUnstyled = React34.forwardRef(function InputUnstyled2(props, ref) {
...
function handleKeyDown2(event, state, props) {
  ...
  switch (event.key) {
    ...
    case "PageUp":
      return _extends({}, state, {
        highlightedIndex: moveHighlight(-pageSize2, "previous", false)
      });
    case "PageDown":
      return _extends({}, state, {
        highlightedIndex: moveHighlight(pageSize2, "next", false)
      });
    case "ArrowUp":
      return _extends({}, state, {
    ...
    case "Enter":
    case " ":
      if (state.highlightedIndex === -1 || options[state.highlightedIndex] === void 0) {
        return state;
      }
...
function useListbox(props) {
  ...
  const getRootProps = (other = {}) => {
    return _extends({}, other, {
      "aria-activedescendant": highlightedIndex >= 0 ? optionIdGenerator(options[highlightedIndex], highlightedIndex) : void 0,
      id,
...
function useSelect(props) {
  ...
  const ignoreEnterKeyUp = React38.useRef(false);
  const ignoreClick = React38.useRef(false);
  const [listboxFocusRequested, requestListboxFocus] = React38.useState(false);
  const focusListboxIfRequested = React38.useCallback(() => {
  ...
  const selectedOption = React38.useMemo(() => {
...
var _excluded15 = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "ownerState", "placement", "popperOptions", "popperRef", "TransitionProps"];
...
var PopperTooltip = React39.forwardRef(function PopperTooltip2(props, ref) {
  const {
    anchorEl,
    children,
    direction,
...
var PopperUnstyled = React39.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
...
true ? PopperUnstyled.propTypes = {
  ...
  modifiers: import_prop_types23.default.arrayOf(import_prop_types23.default.shape({
    ...
    name: import_prop_types23.default.any.isRequired,
...
var SelectUnstyledContext = import_react11.default.createContext(void 0);
...
var MultiSelectUnstyled = React41.forwardRef(function MultiSelectUnstyled2(props, ref) {
  ...
  const [groupedOptions, setGroupedOptions] = React41.useState([]);
  const options = React41.useMemo(() => flattenOptionGroups(groupedOptions), [groupedOptions]);
  ...
  const selectedOptions = React41.useMemo(() => {
    if (value == null) {
      return [];
    }
...
var _excluded18 = ["children", "className", "component", "components", "componentsProps", "disabled", "value"];
...
var SelectUnstyled = React44.forwardRef(function SelectUnstyled2(props, ref) {
  ...
  const selectedOptions = React44.useMemo(() => {
...
function SliderValueLabelUnstyled(props) {
  ...
  }, (0, import_jsx_runtime33.jsxs)(React45.Fragment, {
...
function useSlider(props) {
  ...
  const [focusVisible, setFocusVisible] = React46.useState(-1);
...
var SliderUnstyled = React47.forwardRef(function SliderUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime35.jsxs)(Root, _extends({}, rootProps, getRootProps({
    ...
    children: [(0, import_jsx_runtime34.jsx)(Rail, _extends({}, railProps, {
      ...
      return (0, import_jsx_runtime35.jsxs)(React47.Fragment, {
      ...
      return (0, import_jsx_runtime34.jsx)(React47.Fragment, {
...
var SwitchUnstyled = React49.forwardRef(function SwitchUnstyled2(props, ref) {
...
var useTabs = (props) => {
  ...
  const onSelected = React50.useCallback((e, newValue) => {
    setValue(newValue);
    if (onChange) {
      onChange(e, newValue);
    }
...
var Context = React51.createContext(null);
if (true) {
  Context.displayName = "TabsContext";
}
function useTabContext() {
  return React51.useContext(Context);
}
...
var _excluded24 = ["children", "className", "value", "defaultValue", "orientation", "direction", "component", "components", "componentsProps", "onChange", "selectionFollowsFocus"];
...
var TabsUnstyled = React52.forwardRef((props, ref) => {
...
var _excluded25 = ["children", "className", "value", "components", "componentsProps", "component"];
...
var TabPanelUnstyled = React53.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    children,
    className,
...
var useTabsList = (props) => {
  ...
  const tabsListRef = React54.createRef();
  ...
  const processChildren = React54.useCallback(() => {
    const valueToIndex = /* @__PURE__ */ new Map();
    let childIndex = 0;
    const processedChildren = React54.Children.map(children, (child) => {
...
var _excluded26 = ["className", "children", "component", "components", "componentsProps"];
...
var TabsListUnstyled = React55.forwardRef((props, ref) => {
  var _ref, _componentsProps$root;
  const {
    className,
    component,
...
var _excluded28 = ["action", "children", "value", "className", "disabled", "onChange", "onClick", "onFocus", "component", "components", "componentsProps"];
...
var TabUnstyled = React56.forwardRef(function TabUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    action,
    children,
...
var _excluded29 = ["mode", "contrastThreshold", "tonalOffset"];
var light = {
  text: {
...
function createPalette(palette2) {
  const {
    ...
    contrastThreshold = 3,
    tonalOffset = 0.2
  } = palette2, other = _objectWithoutPropertiesLoose(palette2, _excluded29);
...
var _excluded30 = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
...
var _excluded31 = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function createTheme2(options = {}, ...args) {
  ...
  } = options, other = _objectWithoutPropertiesLoose(options, _excluded31);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-NRCVSEST.js.map
